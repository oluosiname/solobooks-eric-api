...
#ifndef ERIC_FEHLERCODES_H
#define ERIC_FEHLERCODES_H

/**
 * @file
 * @brief Auflistung der ERIC API-Fehlercodes
 */
typedef enum eric_fehlercode {
    ...
    /**
     * [610001002] Fehler während der Plausibilitätsprüfung, Datensatz nicht plausibel. Zur Ermittlung der fehlgeschlagenen Plausibilitätsprüfungen muss der Rückgabepuffer (Parameter "rueckgabeXmlPuffer") ausgewertet werden.
     */
    ...
    /**
     * [610001016] Für dieses Verfahren/diese Datenart ist eine Bearbeitung mit der angegebenen Hersteller-ID nicht erlaubt.
     */
    ...
    /**
     * [610001019] Für dieses Verfahren/diese Datenart/diese Test-Hersteller-ID/diese ERiC-Einstellungen sind Echtfälle nicht erlaubt.
     */
    ...
    /**
     * [610001033] Bei einer arithmetischen Operation ist ein Fehler aufgetreten. Details stehen im Logfile (eric.log).
     */
    ...
    /**
     * [610001042] Die übergebene Datenartversion ist unbekannt oder das benötigte ERiC-Plugin wurde nicht gefunden. Beachten Sie bitte, dass die Datenartversion case-sensitive ist.
     */
    ...
    /**
     * [610001053] Auf eine Datei konnte nicht in gewünschter Weise zugegriffen werden. Details stehen im Logfile (eric.log).
     */
    ...
    /**
     * [610201140] eSigner: Die eSigner-Bibliothek konnte nicht geladen werden
     */
    ERIC_CRYPT_E_ESIGNER_NICHT_GELADEN = 610201140,

    /**
     * [610201141] eSigner: Die eSigner-Bibliothek liegt in einer inkompatiblen Version vor
     */
    ERIC_CRYPT_E_INKOMPATIBLE_ESIGNER_VERSION = 610201141,

    /**
     * [610201142] eSigner: Die eSigner-Bibliothek liegt in einer veralteten Version vor
     */
    ...
    /**
     * [610201228] Die Datenstruktur ist nicht initialisiert
     */
    ERIC_CRYPT_E_DATA_NOT_INITIALIZED = 610201228,

    /**
     * [610201229] Der Lesepuffer zum Dekodieren der ASN.1-Struktur ist zu klein
     */
    ERIC_CRYPT_E_ASN1_READ_BUFFER_TOO_SMALL = 610201229,

    /**
     * [610201230] Die Daten der ASN.1-Struktur sind unvollständig
     */
    ERIC_CRYPT_E_ASN1_READ_DATA_INCOMPLETE = 610201230,

    /**
     * [610201231] Die ASN.1-Struktur enthält kein EnvelopedData
     */
    ERIC_CRYPT_E_ASN1_NO_ENVELOPED_DATA = 610201231,

    /**
     * [610201232] Die ASN.1-Struktur enthält keine Daten
     */
    ...
    /**
     * [610301108] Die Eingabedaten lagen nicht im Encoding UTF-8 ohne BOM vor oder es war kein Encoding spezifiziert.
     */
    ...
    /**
     * [610301170] Es wurden Fehler in den Angaben zur Referenzierung von Belegen (RABE) gefunden. Details stehen im Logfile (eric.log).
     */
    ERIC_IO_READER_RABE_FEHLER = 610301170,

    /**
     * [610301171] Es wurde keine RabeId angegeben, Details stehen ggf. im Logfile (eric.log)
     */
    ERIC_IO_READER_KEINE_RABEID = 610301171,

    /**
     * [610301172] Es wurde eine ungültige RabeId gefunden, Details stehen ggf. im Logfile (eric.log)
     */
    ERIC_IO_READER_RABEID_UNGUELTIG = 610301172,

    /**
     * [610301173] Es wurde eine ungültige VerifikationsId gefunden, Details stehen ggf. im Logfile (eric.log)
     */
    ERIC_IO_READER_RABE_VERIFIKATIONSID_UNGUELTIG = 610301173,

    /**
     * [610301174] Es wurde eine ungültige ReferenzId gefunden, Details stehen ggf. im Logfile (eric.log)
     */
    ERIC_IO_READER_RABE_REFERENZID_UNGUELTIG = 610301174,

    /**
     * [610301175] Es wurde eine ReferenzId für ein Feld angegeben, das keine ReferenzId erlaubt. Details stehen ggf. im Logfile (eric.log)
     */
    ERIC_IO_READER_RABE_REFERENZID_NICHT_ERLAUBT = 610301175,

    /**
     * [610301176] Für einen Nutzdatenblock wurde mehrfach die gleiche ReferenzId angegeben. Details stehen ggf. im Logfile (eric.log)
     */
    ...
    /**
     * [610301192] Die Gesamtgröße aller Anhänge in einem Nutzdatenblock ist zu groß. Details stehen im Logfile (eric.log).
     */
    ERIC_IO_READER_ANHAENGE_ZU_GROSS = 610301192,

    /**
     * [610301193] Der referenzierte Anhang ist zu klein und muss in das XML eingebettet werden. Details stehen im Logfile (eric.log).
     */
    ...
    /**
     * [610301202] Die im XML angegebene Hersteller-ID ist gesperrt. Bitte verwenden Sie Ihre eigene Hersteller-ID auch für Testfälle.
     */
    ...
    /**
     * [610501015] Bei der PDF-Erstellung hat die benutzerdefinierte Callback-Funktion einen Fehler gemeldet.
     */
    ERIC_PRINT_PDFCALLBACK = 610501015

} eric_fehlercode_t;

#endif /* ERIC_FEHLERCODES_H */
